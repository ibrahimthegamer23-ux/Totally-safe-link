...
```javascript
// Basic Information
valentineName: "mina"                    // Your Valentine's name
pageTitle: "Lets go tea time and mina port on the 14th? 💝" // Browser tab title
...
questions: {
    first: {
        text: "Are you free on saturday?",                   // First question
        yesBtn: "Yes",                             // Yes button text
        noBtn: "No",                               // No button text
        secretAnswer: " yes 100%! ❤️"  // Hidden message
    },
    second: {
        text: "get karak from tea time?",          // Second question
        startText: "Yes!",                   // Text before percentage
...
// Love Meter Messages
loveMessages: {
    extreme: "LETS GOOOOO🔥🔥🔥",  // Shows above 5000%
...
// Final Celebration
celebration: {
    title: "This took me an hour  to make...",     // Celebration title
